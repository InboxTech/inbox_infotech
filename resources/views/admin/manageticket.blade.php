...
@endif
	<div class="card-body card-block">
		<form action="{{url('/admin/supporttickets/manageticket/submit')}}" method="post" enctype="multipart/form-data">
			...
			<div class="col-md-9">
			<select class="browser-default custom-select" name="customers" id="customers" required>
			</select>
			</div>
			</div>
			<div class="row form-group">
...
<div class="col-md-9">
<input type="datetime-local" name="approxclosetime" class="form-control" value="{{$approxclosetime}}" required>
</div>
</div>
<div class="row form-group">
<div class="col-md-3">
