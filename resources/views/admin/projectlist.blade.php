...
<div class="col-md-12">
<!-- DATA TABLE -->
<h3 class="title-5 m-b-35">Projects List</h3>
<div class="table-data__tool">
    <form method="post" action="{{url('/admin/projects/list/search/')}}">
    {{ csrf_field() }}
    ...
    <tr class="tr-shadow">
        ...
        <td>
            <div class="table-data-feature">
                <a href="{{url('/admin/projects/update/')}}/{{$list->id}}">
                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                    <i class="zmdi zmdi-edit"></i>
                </button>
                </a>
                <a  onclick="return myFunction();" href="{{url('/admin/projects/delete/')}}/{{$list->id}}">
