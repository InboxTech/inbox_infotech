...
<div class="card">
	<div class="card-header">
		<strong>Basic Form</strong>Manage Projects
	</div>
@if ($errors->any())
...
@endif
	<div class="card-body card-block">
		<form action="{{url('/admin/projects/manageprojects/submit')}}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
...
<div class="card-footer">
		...
		<a href="{{url('/admin/projects/list')}}"><span  class="btn btn-danger btn-sm" style="background-color:#C82333">
