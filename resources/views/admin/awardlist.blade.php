...
<div class="col-md-12">
<!-- DATA TABLE -->
<h3 class="title-5 m-b-35">Award List</h3>
<div class="table-data__tool">
    <form method="post" action="{{url('/admin/award/list/search/')}}">
    {{ csrf_field() }}
...
<div class="table-data__tool-left">
    <a href="{{url('/admin/award/list')}}">
<button type="submit" class="au-btn au-btn-icon au-btn--green au-btn--small" style="background-color:#08324A">
			<i class="fas fa-list-ul"></i> All Data
		</button>
</div>
<div class="table-data__tool-right">
<a href="{{url('/admin/award/add')}}">
    ...
    <tr class="tr-shadow">
        ...
        <td>
            <div class="table-data-feature">
                <a href="{{url('/admin/award/update/')}}/{{$list->id}}">
                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                    <i class="zmdi zmdi-edit"></i>
                </button>
                </a>
                <a  onclick="return myFunction();" href="{{url('/admin/award/delete/')}}/{{$list->id}}">
