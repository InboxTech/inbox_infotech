                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="{{ url('/admin/career/jobapplication/managejobapp/submit') }}"
                                        method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label"><b>Job</b></label>
                                                <label for="text-input" class=" form-control-label">Application for
                                                    *</label>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label"><b>Personal
                                                        Data</b></label>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-6">
                                                ...
                                                {{-- <input type="text" id="disabled-input" disabled=""
                                                    class="form-control" value="{{ $citizenship }}"> --}}
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <label for="text-input" class=" form-control-label">Ready to reallocates
                                                </label>
                                                <input type="text" id="disabled-input" disabled=""
                                                    class="form-control" value="<?php if ($ready_to_reallocates == '1') {
                                                        echo 'Yes';
                                                    } ?>">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="disabled-input" disabled=""
                                                    class="form-control" value="{{ $email_id }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="text-input" class=" form-control-label">Phone Number
                                                </label>
                                                <input type="text" id="disabled-input" disabled=""
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label"><b>Application
                                                        documents</b></label>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    {{-- <a href="{{ asset('storage/media/') }}/{{ $photo }}"
                                                        target="_blank"><img
                                                            src="{{ asset('storage/media/') }}/{{ $photo }}"
                                                            width= '100' height='100'
                                                            class="img img-responsive" /></a> --}}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="text-input" class=" form-control-label">Curriculum
                                                    vitae</label>
                                                <div class="col-12 col-md-3">
                                                    <a href="{{ asset('storage/media/') }}/{{ $resume }}"
                                                        target="_blank"><img src="{{ asset('pdf.jfif') }}"
                                                            width= '100' height='100'
                                                            class="img img-responsive" /></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input"
                                                    class=" form-control-label"><b>Qualification</b></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input"
                                                    class=" form-control-label"><b>Experience</b></label>
                                            </div>
                                        </div>
                                        <div class="table-responsive table--no-card m-b-30">
                                            <div class="row form-group">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ url('/admin/career/jobapplication/list') }}"><span
                                                    class="btn btn-danger btn-sm" style="background-color:#C82333">
