...
<div class="table-data__tool">
    <form method="post" action="{{url('/admin/testimonial/list/search/')}}">
    {{ csrf_field() }}
    ...
    <tr class="tr-shadow">
        ...
        <td>
            <div class="table-data-feature">
                <a href="{{url('/admin/testimonial/update/')}}/{{$list->id}}">
                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                    <i class="zmdi zmdi-edit"></i>
                </button>
                </a>
                <a  onclick="return myFunction();" href="{{url('/admin/testimonial/delete/')}}/{{$list->id}}">
