...
@section('title', 'Manage Clients Logo')
...
<div class="card">
	<div class="card-header">
		<strong>Basic Form</strong> Clients Logo
	</div>
@if ($errors->any())
...
@endif
	<div class="card-body card-block">
		<form action="{{url('/admin/clientlogo/manageclientlogo/submit')}}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
...
<div class="card-footer">
		...
		<a href="{{url('/admin/clientlogo/list')}}"><span  class="btn btn-danger btn-sm" style="background-color:#C82333">
