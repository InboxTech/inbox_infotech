...
@section('title', 'Clients Logo List')
@section('psg', 'Active')
@section('main')
...
<div class="col-md-12">
<!-- DATA TABLE -->
<h3 class="title-5 m-b-35">Clients Logo List</h3>
<div class="table-data__tool">
    <form method="post" action="{{url('/admin/clientlogo/list/search/')}}">
    {{ csrf_field() }}
...
<div class="table-data__tool-left">
    <a href="{{url('/admin/clientlogo/list')}}">
<button type="submit" class="au-btn au-btn-icon au-btn--green au-btn--small" style="background-color:#08324A">
			<i class="fas fa-list-ul"></i> All Data
		</button>
</div>
<div class="table-data__tool-right">
<a href="{{url('/admin/clientlogo/add')}}">
    ...
    <tr class="tr-shadow">
        ...
        <td>
            <div class="table-data-feature">
                <a href="{{url('/admin/clientlogo/update/')}}/{{$list->id}}">
                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                    <i class="zmdi zmdi-edit"></i>
                </button>
                </a>
                <a  onclick="return myFunction();" href="{{url('/admin/clientlogo/delete/')}}/{{$list->id}}">
