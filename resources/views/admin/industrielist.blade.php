...
<div class="col-md-12">
<!-- DATA TABLE -->
<h3 class="title-5 m-b-35">Industry List</h3>
<div class="table-data__tool">
    <form method="post" action="{{url('/admin/industry/list/search/')}}">
    {{ csrf_field() }}
...
<tbody>
    ...
    <tr class="tr-shadow">
        ...
        <td class="desc"><?php echo $msgTrimmed = mb_substr($list->short_desc,0,30);?></td>
        <td>
        ...
        <td>
            <div class="table-data-feature">
                <a href="{{url('/admin/industry/update/')}}/{{$list->id}}">
                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                    <i class="zmdi zmdi-edit"></i>
                </button>
                </a>
                <a  onclick="return myFunction();" href="{{url('/admin/industry/delete/')}}/{{$list->id}}">
