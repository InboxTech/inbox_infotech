...
<div class="card">
	<div class="card-header">
		<strong>Basic Form</strong>Manage Award
	</div>
@if ($errors->any())
...
@endif
	<div class="card-body card-block">
		<form action="{{url('/admin/award/manageaward/submit')}}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="row form-group">
				...
				<div class="col-12 col-md-9">
					...
					<small class="form-text text-muted">Enter the Award Name</small>
				</div>
			</div>
			<div class="row form-group">
				<div class="col col-md-3">
...
<div class="card-footer">
		...
		<a href="{{url('/admin/award/list')}}"><span  class="btn btn-danger btn-sm" style="background-color:#C82333">
