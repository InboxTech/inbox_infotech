...
@section('title', 'Manage Ticket Subcategory')
...
Edit
@endif	
Ticket Subcategory</h3>
<div class="col-lg-12">
<div class="card">
	<div class="card-header">
		<strong>Basic Form</strong>Manage Ticket Subcategory
	</div>
@if ($errors->any())
...
@endif
	<div class="card-body card-block">
		<form action="{{url('/admin/tieket_sub_category/managecategory/submit')}}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
...
<div class="card-footer">
		...
		<a href="{{url('/admin/tieket_sub_category/list')}}"><span  class="btn btn-danger btn-sm" style="background-color:#C82333">
