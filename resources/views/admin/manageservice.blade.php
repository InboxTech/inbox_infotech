...
@section('main')
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Basic Form</strong> Services
                                </div>
                                @if ($errors->any())
                                ...
                                <div class="card-body card-block">
                                    <form action="{{ url('/admin/service/manageservice/submit') }}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="row col-md-9">
                                                ...
                                                <div class="col-6 d-flex justify-content-end">
                                                    @if ($imaage != '')
                                                        <a href="{{ asset('storage/media/services/' . $imaage) }}" target="_blank">
                                                            <img width="100%" src="{{ asset('storage/media/services/' . $imaage) }}" />
                                                        </a>
                                                    @endif
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-6">
                                                                                @if ($pAArr['attr_image'] != '')
                                                                                    <img width="300px" src="{{ asset('storage/media/services/' . $pAArr['attr_image']) }}" />
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-2 py-3">
                                                                        ...
                                                                        @else
                                                                        <a href="{{ url('admin/service/service_attr_delete/') }}/{{ $pAArr['id'] }}/{{ $id }}">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ url('/admin/service/list') }}">
                                                <span class="btn btn-danger btn-sm" style="background-color:#C82333">
    ...
    <script>
        ...
        function add_more() {
            ...
            html += '<div class="col-md-6"><label for="attr_image" class="control-label mb-1"> Image</label><input id="attr_image" name="attr_image[]" type="file" class="form-control" aria-required="true" aria-invalid="false" ></div>';
            ...
            html += '<div class="col-md-2 py-3"><label for="attr_image" class="control-label mb-1"> &nbsp;&nbsp;&nbsp;</label><button type="button" class="btn btn-danger" style="background-color:#C82333" onclick=remove_more("' + loop_count + '")><i class="fa fa-minus"></i>&nbsp; Remove</button></div>';
