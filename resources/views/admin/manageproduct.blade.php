...
<div class="card">
	<div class="card-header">
		<strong>Basic Form</strong> Product
	</div>
@if ($errors->any())
...
@endif
	<div class="card-body card-block">
		<form action="{{url('/admin/product/manageproduct/submit')}}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
		...
		<small class="help-block form-text">Please enter a short details</small>
			...
			<div class="row form-group">
				<div class="col col-md-3">
					<label for="email-input" class=" form-control-label">Text 3</label>
				</div>
				<div class="col-12 col-md-9">
					<input type="text" id="tax3" name="tax3" class="form-control" value="{{$tax3}}">
				</div>
			</div>
			<div class="row form-group">
				<div class="col col-md-3">
...
<div class="col-12 col-md-9">
			...
			<h2 class="mb10 ml15">Products Images</h2><br>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                           ...
                           <div class="col-md-4">
                              ...
                              @else
                              <a href="{{url('admin/product/product_attr_delete/')}}/{{$pAArr['id']}}/{{$id}}"><button type="button" class="btn btn-danger btn-lg" style="background-color:#C82333">
