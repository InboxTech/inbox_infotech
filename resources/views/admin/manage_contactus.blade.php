                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="{{ url('admin/contactus/manage_contactus_process') }}" method="post"
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="disabled-input" value="{{ $name }}"
                                                        name="name" disabled="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="disabled-input" value="{{ $email }}"
                                                        name="email" disabled="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label for="category_name" class="control-label mb-1">Phone
                                                        Number</label>

                                                </div>
                                                <div class="col-md-9">
                                                    <input type="text" id="disabled-input" value="{{ $phone }}"
                                                        name="phone" disabled="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="disabled-input" value="{{ $ip }}"
                                                        name="ip" disabled="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="disabled-input" value="{{ $created_at }}"
                                                        name="ip" disabled="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
