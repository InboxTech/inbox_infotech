                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                           ...
                           <div class="col-md-4">
                              ...
                              @else
                              <a href="{{url('admin/blog/blog_attr_delete/')}}/{{$pAArr['id']}}/{{$id}}"><button type="button" class="btn btn-danger btn-lg" style="background-color:#C82333">
...
<div class="card-footer">
		...
		<a href="{{url('/admin/blog/list')}}"><span  class="btn btn-danger btn-sm" style="background-color:#C82333">
