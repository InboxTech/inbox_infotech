                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="{{url('/admin/blog/manageblog/submit')}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="row col-md-9">
                                                ...
                                                <div class="col-6 d-flex justify-content-end">
                                                    @if($imaage!='')
                                                    <a href="{{asset('storage/media/blogs/'.$imaage)}}" target="_blank">
                                                        <img  width="100%" src="{{asset('storage/media/blogs/'.$imaage)}}"/></a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{url('/admin/blog/list')}}">
                                                <span  class="btn btn-danger btn-sm" style="background-color:#C82333"><i class="fa fa-ban"></i> Reset</span>
                                            </a>
                                        </div>
                                    </form>
                                </div>
...
<script>
 var loop_count=1;
   function add_more(){
       ...
       html+='<div class="col-md-2 py-3"><button type="button" class="btn btn-danger" style="background-color:#C82333" onclick=remove_more("'+loop_count+'")><i class="fa fa-minus"></i>&nbsp; Remove</button><label for="attr_image" class="control-label mb-1"> &nbsp;&nbsp;&nbsp;</label></div>';
