  ...
  <main class="main" id="top">
    ...
    <div class="swiper theme-slider min-vh-100"
      ...
      <div class="swiper-slide" data-zanim-timeline="{}">
        <div class="bg-holder">
          <img src="{{ asset('storage/media/1214549853.jpg') }}" alt="recruitment & staffing" class="lcp-image" fetchpriority="high"  width="1920" height="1080" loading="lazy"/>
        </div>
        <!--/.bg-holder-->
        <div class="container">
    ...
    <section>
      ...
      <div class="swiper myClientSwiper">
        ...
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1665116922.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1665117520.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1665117298.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1673940283.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1745238697.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1745235052.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1745238602.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1673943640.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1673943414.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/1665117275.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/7.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">

        </div>
        <div class="swiper-slide">
          <img src="{{asset('storage/media/8.png')}}" class="w-100 h-100" alt="client logo" loading="lazy">
    ...
    <section>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        ...
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/oracle.png')}}" class="w-100 h-100" alt="oracle consultant" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/SAP_Consultancy.png')}}" class="w-100 h-100" alt="SAP consultant" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/Hadoop.png')}}" class="w-100 h-100" alt="Hadoop consultant" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/Salesforce-Developers.png')}}" class="w-100 h-100" alt="Salesforce developers" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/ServiceNow-Developers.png')}}" class="w-100 h-100" alt="ServiceNow developers" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/AI_ML_Development.png')}}" class="w-100 h-100" alt="AI and ML development" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/Frontend_Development.png')}}" class="w-100 h-100" alt="Frontend development" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/Backend_Development.png')}}" class="w-100 h-100" alt="Backend development" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/mobile_app_developer.png')}}" class="w-100 h-100" alt="Mobile app developer" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/Database_Administration.png')}}" class="w-100 h-100" alt="Database administration" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/Datacenter_Solutions.png')}}" class="w-100 h-100" alt="Datacenter solutions" loading="lazy">
        </div>
      ...
      <div class="col-lg-4 col-md-6 my-3">
        <div class="card shadow p-3" style="height: 100%;">
        <div style="width: 30%; margin: 4% 0;">
          <img src="{{asset('assets/inbox/Cyber_Security_Services.png')}}" class="w-100 h-100" alt="Cyber security services" loading="lazy">
        </div>
