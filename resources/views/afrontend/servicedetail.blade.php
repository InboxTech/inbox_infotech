              ...
              <div class="row min-vh-100 py-8 align-items-center" data-inertia='{"weight":1.5}'>
                <div class="col-sm-12 col-lg-12 px-6 px-sm-6">
                  <div style="background-color: #ffffff88; padding:30px; border-radius: 10px;">
                    ...
                    <div class="overflow-hidden">
                      <p class="text-primary pt-4 mb-5 fs-1 fs-md-2 lh-xs" data-zanim-xs='{"delay":0.1}'>{{$servicedetails->tax2}}</p>
                    </div>
                    <div class="overflow-hidden">
          ...
          <div class="bg-white px-3 mt-6 px-0 py-5  rounded-3">
              ...
              <div class="col-lg-8">
                <p style="text-align:left">{!! $servicedetails->short_desc !!}</p>
				      ...
				      <div class="col-lg-4"><img src="{{ asset('storage/media/')}}/{{$servicedetails->imaage}}" class="img-fluid" alt="{{$servicedetails->image_alt}}"/></div>
            </div>
			    </div>
		    </div>
