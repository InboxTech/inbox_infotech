...
@section('container')
    ...
    <section style="height: 340px;">
        <div class="bg-holder overlay"
            style="background-image:url({{ url('/assets/img/background-2.jpg') }});background-position:center bottom;"></div>
        <!--/.bg-holder-->
        <div class="container">
            <div class="row pt-6">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <div class="nav" aria-label="breadcrumb" role="navigation" data-zanim-xs='{"delay":0.1}'>
                            <ol class="breadcrumb fs-1 ps-0 fw-bold">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a class="text-white"
                                        href="{{ url('/careers') }}">Career</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        @if ($message = Session::get('success'))
                            <div class="alert alert-success alert-block" style="color:#00406d;">
                            ...
                            <form action="{{ url('/jobapplication/submit') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        Yes <input type="radio" name="ready_to_reallocates" value="1"
                                            class="form-control-label" required>
                                        No <input type="radio" name="ready_to_reallocates" Value="0"
                                            class="form-control-label" required>
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6 ">
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Upolad Resume</label>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ url()->current() }}"><span class="btn btn-danger btn-sm"
