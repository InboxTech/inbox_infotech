            ...
            <div class="row">
			  ...
			  <h6 class="text-white" style="font-size: 1.333rem;letter-spacing: -0.05rem;"><u>Important Links</u></h6>
                <ul class="list-unstyled">
				  <li class="mb-3"><a class="text-white" href="{{url('/about-us')}}" role="button">About Us</a></li>
			      ...
			      <li class="mb-3"><a class="text-white" href="{{url('/contact-us')}}" role="button">Contact Us</a></li>				  
                </ul>
              </div>			  
