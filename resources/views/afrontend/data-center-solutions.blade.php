            ...
            <div class="swiper theme-slider min-vh-100"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" data-zanim-timeline="{}">
                        <div class="bg-holder">
                            <img src="{{asset('storage/media/services/banner/Data_Center_Solution.png') }}" alt="Data center solution" class="lcp-image" fetchpriority="high"  width="1920" height="1080" loading="lazy"/>
                        </div>
                        <!--/.bg-holder-->
                        <div class="container">
