  ...
  <main class="main" id="top">
    ...
    <section class="web-dev-process">
      ...
      <div class="text-center my-5" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p> We collaborate with the client to understand their business goals, target audience, and required website
        features—such as services, contact forms, team profiles, and branding. This helps us define the project
      ...
      <div class="my-5 p-5">
        ...
        <div class="web-process web-process-left shadow  my-4">
          ...
          <p> We gather information about the website's content, target audience, and content needs to define the
        ...
        <div class="web-process web-process-right shadow my-4 ">
          ...
          <p> We outline the website structure, features, and technology stack, then provide a detailed proposal
        ...
        <div class=" web-process web-process-left shadow  my-4 ">
          ...
          <div>
          <h4> Design (UI/UX) </h4>
          <p> We create user-friendly, responsive designs that reflect the company’s brand, including layout
        ...
        <div class="web-process web-process-right shadow my-4 ">
          ...
          <div>
          <h4> Development </h4>
          <p> We build the website by transforming designs into functional code, incorporating features like
            content management systems (CMS), forms, and databases, ensuring optimal performance and security.</p>
          </div>
          <div class="right-container-arrow"></div>
        ...
        <div class="web-process web-process-left shadow  my-4">
          ...
          <p> We thoroughly test the website across different devices and browsers to ensure all features work
        ...
        <div class="web-process web-process-right shadow  my-4 ">
          ...
          <div>
          <h4> Deployment </h4>
          <p> We prepare the website for launch by setting up hosting, configuring the domain, and transferring
            files to the live server, ensuring everything is optimized and functioning as expected. </p>
          </div>
          <div class="right-container-arrow"></div>
        ...
        <div class="web-process web-process-left shadow  my-4">
          ...
          <p> We provide training on how to manage and update the website, along with documentation, ensuring the
        ...
        <div class="web-process web-process-right shadow my-4 ">
          ...
          <p> We offer ongoing support to ensure the website runs smoothly, providing updates, security patches,
    ...
    <section class="my-5 agile-approach">
      <div class="container">
      <div class="text-center mb-6" data-aos="fade-up" data-aos-duration="1000">
        <h6 class="fs-2 fs-md-3 text-color" style="font-size: 2.368593037rem"> Software Development Methodology </h6>
        <p> Our company specializes in software development services designed to meet the unique needs of modern
        businesses. From custom applications to enterprise solutions, we deliver reliable, scalable, and secure
        software tailored to support growth and innovation. Using proven methodologies and the latest technologies,
        our development team ensures efficient project execution, timely delivery, and long-term support. </p>
        <hr class="short"
        data-zanim-xs='{"from":{"opacity":0,"width":0},"to":{"opacity":1,"width":"4.20873rem"},"duration":0.8}'
        data-zanim-trigger="scroll" />
      </div>
      ...
      <div>
        ...
        <div class="col-lg-3 col-md-6 my-3">
          ...
          <div class="card-body p-3">
            ...
            <p> We utilize Agile development to deliver flexible, customer-driven solutions through iterative cycles, ensuring continuous feedback, faster delivery, and the ability to adapt to changing needs. </p>
          </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 my-3">
          <div style="height: 100%;" class="card shadow p-3">
          <div style="width: 25%; margin: 3% 0;">
            <img src="{{asset('assets/img/icons/svg_icons/waterfall_developemnt.png')}}" class="img-fluid">
          </div>
          <div class="card-body p-3">
            <h4 class="text-color"> Waterfall <br> Development</h4>
            <p> We follow the Waterfall development model for projects with clear requirements, ensuring structured, step-by-step execution from planning to deployment with predictable outcomes.
            </p>
          </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 my-3">
          <div style="height: 100%;" class="card shadow p-3">
          <div style="width: 25%; margin: 3% 0;">
            <img src="{{asset('assets/img/icons/svg_icons/Rapid_developement.png')}}" class="img-fluid">
          </div>
          <div class="card-body p-3">
            <h4 class="text-color"> Rapid <br> Development </h4>
            <p> We use Rapid Application Development to quickly build and refine software through prototyping and user feedback, ensuring faster delivery and improved client satisfaction.</p>
          </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 my-3">
          ...
          <div class="card-body p-3">
            ...
            <p> We implement DevOps practices to streamline development and operations, ensuring faster delivery, continuous integration, and improved collaboration for reliable, high-quality software solutions.
            </p>
          </div>
          </div>
        </div>
    ...
    <section class="my-5">
      ...
      <div>
        ...
        <p class="text-white">Working with our certified experts means you get tailored, high-quality solutions, delivered on time and within budget. We ensure seamless collaboration, leveraging industry-best practices to bring your vision to life with efficiency and reliability.
        </p>
          <!-- </div> -->
          </div>
        </div>
        <div class="col-lg-7">
          ...
          <div class="row">
            ...
            <div class="h-100 shadow p-3">
              ...
              <img src="{{asset('assets/img/icons/svg_icons/Creative_Support.svg')}}" alt="icon"
                class="img-fluid" data-zanim-xs='{"delay":0}' />
              </div>
              <div class="text-center">
        ...
        <p class="mb-0" data-zanim-xs='{"delay":0.2}'>We transform brands, grow businesses, and tell brand and product stories in a most creative way.</p>
            ...
            <div class="h-100 shadow p-3">
              <div class="w-50 p-3 mx-auto">
              <img src="{{asset('assets/img/icons/svg_icons/Creating_Experiences.svg')}}" alt="icon"
                class="img-fluid" data-zanim-xs='{"delay":0}' />
              </div>
              <div class="text-center">
        ...
        <p class="mb-0" data-zanim-xs='{"delay":0.2}'>We cover a large range of creative platforms and digital projects with one purpose: to create experiences.</p>
            ...
            <div class="h-100 shadow p-3">
              <div class="w-50 p-3 mx-auto">
              <img src="{{asset('assets/img/icons/svg_icons/Product_Consulting.svg')}}" alt="icon"
                class="img-fluid" data-zanim-xs='{"delay":0}' />
              </div>
              <div class="text-center">
        ...
        <p class="mb-0" data-zanim-xs='{"delay":0.2}'>We guide you through the pipelines that generate new products with higher potential and lower risk.</p>
            ...
            <div class="h-100 shadow p-3">
              <div class="w-50 p-3 mx-auto">
              <img src="{{asset('assets/img/icons/svg_icons/Business_Boosting.svg')}}" alt="icon"
                class="img-fluid" data-zanim-xs='{"delay":0}' />
              </div>
              <div class="text-center">
        ...
        <p class="mb-0" data-zanim-xs='{"delay":0.2}'>We provide energy-efficient and environmentally conservative solutions to our clients to boost their business.</p>
            ...
            <div class="h-100 shadow p-3">
              <div class="w-50 p-3 mx-auto">
              <img src="{{asset('assets/img/icons/svg_icons/Strategic_Approach.svg')}}" alt="icon"
                class="img-fluid" data-zanim-xs='{"delay":0}' />
              </div>
              <div class="text-center">
        ...
        <p class="mb-0" data-zanim-xs='{"delay":0.2}'>Based on solid strategic framework and real, relevant research, we create prototypes, not presentations.</p>
            ...
            <div class="h-100 shadow p-3">
              <div class="w-50 p-3 mx-auto">
              <img src="{{asset('assets/img/icons/svg_icons/Logistic_Consulting.svg')}}" alt="icon"
                class="img-fluid" data-zanim-xs='{"delay":0}' />
              </div>
              <div class="text-center">
