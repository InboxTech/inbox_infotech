            ...
            {{-- <div class="row justify-content-between">
              <div class="col-lg-4 my-2"> --}}
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <a class="nav-link active" id="backend-tab" data-bs-toggle="tab" data-bs-target="#backend" role="tab" aria-controls="backend" aria-selected="false">Backend  </a>
                   </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="frontend-tab" data-bs-toggle="tab" data-bs-target="#frontend" role="tab" aria-controls="frontend" aria-selected="false">Frontend  </a>
                </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="aiml-tab" data-bs-toggle="tab" data-bs-target="#aiml" role="tab" aria-controls="aiml" aria-selected="false"> AI/ML  </a>
                </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="datastore-tab" data-bs-toggle="tab" data-bs-target="#datastore" role="tab" aria-controls="datastore" aria-selected="false"> Database   </a>
                </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="server-tab" data-bs-toggle="tab" data-bs-target="#server" role="tab" aria-controls="server" aria-selected="true"> Servers </a>
                </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="devop-tab" data-bs-toggle="tab" data-bs-target="#devop" role="tab" aria-controls="devop" aria-selected="false"> DevOps  </a>
                </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="monitoring-tab" data-bs-toggle="tab" data-bs-target="#monitoring" role="tab" aria-controls="monitoring" aria-selected="false"> Monitoring   </a>
                </li>

                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="api-tab" data-bs-toggle="tab" data-bs-target="#api" role="tab" aria-controls="api" aria-selected="false">API  </a>
                </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="analytics-tab" data-bs-toggle="tab" data-bs-target="#analytics" role="tab" aria-controls="analytics" aria-selected="false"> Analytics   </a>
                </li>
                   {{-- <li class="nav-item" role="presentation">
                  <a class="nav-link" id="behaproana-tab" data-bs-toggle="tab" data-bs-target="#behaproana" role="tab" aria-controls="behaproana" aria-selected="false"> Behavioral Analytics  </a>
                </li> --}}
                   {{-- <li class="nav-item" role="presentation">
                  <a class="nav-link" id="cloud-tab" data-bs-toggle="tab" data-bs-target="#cloud" role="tab" aria-controls="cloud" aria-selected="false"> Cloud  </a>
                </li> --}}
                   {{-- <li class="nav-item" role="presentation">
                  <a class="nav-link" id="docmanage-tab" data-bs-toggle="tab" data-bs-target="#docmanage" role="tab" aria-controls="docmanage" aria-selected="false"> Document Management  </a>
                </li>
                   <li class="nav-item" role="presentation">
                  <a class="nav-link" id="projectmanage-tab" data-bs-toggle="tab" data-bs-target="#projectmanage" role="tab" aria-controls="projectmanage" aria-selected="false"> Project Management   </a>
                </li> --}}
                </ul>
              {{-- </div> --}}
              {{-- <div class="col-lg-8 my-2"> --}}
                <div class="tab-content my-3">
                  ...
                  {{-- <div class="tab-pane fade" id="behaproana" role="tabpanel" aria-labelledby="behaproana-tab" tabindex="0">
                    <div class="row align-items-center justify-content-center">
                      <div class="col-lg-2 col-md-3 col-sm-6 my-2">
                        <div class="border text-center" style="height: 100%;">
                          <div style="width: 40%;margin: 3% auto;">
                  ...
                  {{-- <div class="tab-pane fade" id="docmanage" role="tabpanel" aria-labelledby="docmanage-tab" tabindex="0">
                    <div class="row align-items-center justify-content-center">
                      <div class="col-lg-2 col-md-3 col-sm-6 my-2">
                        <div class="border text-center" style="height: 100%;">
                          <div style="width: 40%;margin: 3% auto;">
                  ...
                  <div class="tab-pane fade" id="projectmanage" role="tabpanel" aria-labelledby="projectmanage-tab" tabindex="0">
                    <div class="row align-items-center justify-content-center">
                      <div class="col-lg-2 col-md-3 col-sm-6 my-2">
                        <div class="border text-center" style="height: 100%;">
                          <div style="width: 40%;margin: 3% auto;">
