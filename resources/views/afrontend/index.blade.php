                        ...
                        <div class="col-lg-3 col-md-6 ">
                            <div class="my-5 progress-no">
                                <h4 class="fs-3 fs-lg-3 mb-0 fw-bold lh-xs countup-plus" data-zanim-xs='{"delay":0.1}'
                                    data-countup='{"endValue":250}'>250</h4>
                                <h6 class="fs-0" data-zanim-xs='{"delay":0.2}'>Experts in Our Team</h6>
                            </div>
                            <div class="my-5 progress-no">
                                <h4 class="fs-3 fs-lg-3 mb-0 fw-bold lh-xs countup-plus" data-zanim-xs='{"delay":0.1}'
                                    data-countup='{"endValue":500}'>500</h4>
        ...
        <section class="bg-primary py-6 text-center text-md-start">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md">
                        <h6 class="text-white mb-0" style="letter-spacing: -0.05rem;font-size: 1.77689rem;">If you have
                            any query
