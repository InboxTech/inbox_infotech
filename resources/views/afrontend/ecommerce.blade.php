            ...
            <div class="swiper theme-slider min-vh-100"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" data-zanim-timeline="{}">
                        <div class="bg-holder">
                            <img src="{{ asset('storage/media/retail&e-commerce.jpg') }}" alt="retail ecommerce" class="lcp-image" fetchpriority="high"  width="1920" height="1080" loading="lazy"/>
                        </div>
                        <!--/.bg-holder-->
                        <div class="container">
                ...
                <section>
                    ...
                    <div class="my-5">
                        <div class="row" data-aos="fade-up" data-aos-duration="1000">
                            <div class="col-lg-6">
                                <img src="{{ asset('assets/inbox/educational_resource.png') }}" class="w-100 h-100" style="border-radius: 30px;" alt="educational resources" loading="lazy"/>
                            </div>
                            <div class="col-lg-6">
            ...
            <section>
                ...
                <div class="my-5">
                    <div class="row" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="col-lg-6">
                            <img src="{{ asset('assets/inbox/study_with_parents.png') }}" class="w-100 h-100" style="border-radius: 30px;" alt="study-with-parent" loading="lazy"/>
                        </div>
