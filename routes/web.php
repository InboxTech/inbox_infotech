...
Route::get('/products/e-commerce',[FrontController::class,'Ecommerce']);
Route::get('/products/hrtech',[FrontController::class,'hrTech']);
Route::get('/products/travel-hospitality',[FrontController::class,'travelHospitality']);
Route::get('/products/edtech',[FrontController::class,'edTech']);
Route::get('/products/insurtech',[FrontController::class,'insurTech']);
Route::get('/products/pharma-iq-erp',[FrontController::class,'pharmaIQERP']);
Route::get('/products/quantrx-r&d',[FrontController::class,'quantRXRD']);
Route::get('/products/{name}',[FrontController::class,'product']);
Route::get('/industries',[FrontController::class,'industries']);
Route::get('/industries/oil-gas',[FrontController::class,'oilGas']);
Route::get('/industries/manufacturing',[FrontController::class,'manufacturing']);
Route::get('/industries/pharmaceuticals',[FrontController::class,'pharmaceutical']);
